        ...
        <div className="h-screen">
          ...
          <section className="mt-12 md:mt-16">
            ...
            <p className="max-w-[100%] md:max-w-[60%] text-[#fff] text-sm md:text-[17px] mt-2">
              ...
              </span> I build simple, accessible and mobile responsive websites for individuals and companies. I also create and integrate APIs into web apps that help keep data in sync, automate tasks and enhance productivity. Additionally, I provide continous support for existing projects which may include fixes, updates and development of additional functionality or features. 
            </p>
